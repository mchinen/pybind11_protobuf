...
struct cpp_to_py_impl {
 public:
  ...
  static pybind11::object copy(const ::google::protobuf::Message &src);
  ...
  static std::pair<pybind11::object, bool> move_or_copy(ProtoType &&src) {
    ...
    if (auto *cast = ::google::protobuf::DynamicCastToGenerated<ProtoType>(result_message);
        cast != nullptr) {
  ...
  static std::pair<pybind11::object, bool> move_or_copy(::google::protobuf::Message &&src) {
 ...
 public:
  ...
  bool load(handle src, bool convert) {
    ...
    return load_message_impl(message,
                             std::is_same<::google::protobuf::Message, ProtoType>{});
  }

  bool load_message_impl(const ::google::protobuf::Message *message,
